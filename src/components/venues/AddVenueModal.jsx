...
const AddVenueModal = ({ isOpen, onClose, onVenueAdded }) => {
        ...
        <div className="bg-white bg-opacity-70 backdrop-blur-md rounded-md p-6 mx-4 max-w-lg z-20 relative">
          ...
          <div className="mt-4">
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <button type="button" onClick={handleAddImageField} className="mt-2 px-2 py-1 bg- bg-indigo-100 text-indigo-600 rounded-md shadow-md hover:bg-zinc-100">
                Add Image
              </button>
